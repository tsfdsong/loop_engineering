...
- [x] ~~3 个测试脚本通过（composite-recognition / orchestrator-execution / failure-defenses）~~（v6.1.1 已删除 — ALPHA MOCK 验证阶段）
- [x] ~~v5.4 SKILL.md 备份存在（skills/skill-hub/SKILL.md.v5.4.backup）~~（v6.1.1 已删除 — 黄金轨迹 + base_compat 仍保留）

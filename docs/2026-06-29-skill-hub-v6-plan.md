...
**Files:**
- Create: `scripts/record-v54-golden-traces.py`
...
**Files:**
- Create: `scripts/test-composite-recognition.py`
...
**Files:**
- Create: `scripts/test-orchestrator-execution.py`
...
**Files:**
- Create: `scripts/test-failure-defenses.py`
...
**Files:**
- Create: `docs/migration-guide-v5-to-v6.md`
...
- [ ] **类型一致性**：所有 JSON Schema、Python 类型一致
  - trace_id 在 trace-format.md 和 test-orchestrator-execution.py 中都是 UUID/字符串

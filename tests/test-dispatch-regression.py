...
def test_v6_skill_hub_version_compat():
    """v6.2.1 单技能路由仍兼容（v5.4/v6.0/v6.1 base_compat 保留）"""
    ...
    # v6.2.1 frontmatter 应同时声明 base_compat 5.4 / base_compat_v6 6.0 / base_compat_v6_1 6.1
    assert 'version: "6.2.1"' in content, "应升级到 v6.2.1（回滚合并 8）"
    ...
    print("✅ test_v6_skill_hub_version_compat (v5.4 + v6.0 + v6.1 + v6.2.1 四兼容)")

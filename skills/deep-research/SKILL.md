...
display_name: 深度调研
description: |
  TRIGGER: 数据驱动调研 / 对比 / 选型 / 综述 / 报告 / 市场分析 / 竞品分析 / '调研' / '对比' / '选型' / 'review' / 'survey' / 'research'（不用于：brainstorming 新功能用 brainstorming，实施计划用 spec-driven-development，架构审查用 system-review）
...
- ❌ **不替代 spec-driven-development** — 本技能不写"实施计划"，产出的是"调研报告"或"PRD 草稿"
...
- `spec-driven-development` — 实施计划（本技能的产出可作为 spec-driven-development 的输入）
